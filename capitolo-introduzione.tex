...
\item Libertà di \textbf{ridistribuzione}, in questo caso le aziende non solo possono creare per se stesse, ma anche mettere la nuova versione a disposizione di altri. Software libero come bene comune (\glossario{Routes}, \glossario{Beowulf}, \glossario{nslu2}). Una volta che posso ridistribuire ad altri allora il mio lavoro diventa realmente usabile. 
...
\textbf{RedHat Enterprise} sistema i bugs previo pagamento e questi vengono risolti molto presto. Loro distribuiscono i sorgenti ma non i binari.
